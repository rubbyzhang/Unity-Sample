...
////// Lighting:
////// Emissive:
                float4 node_6616 = _Time + _TimeEditor;
                float2 node_9683 = (i.uv0+node_6616.g*float2(0,0));
                float4 _node_7520_var = tex2D(_node_7520,TRANSFORM_TEX(node_9683, _node_7520));
                float node_5534 = pow(_node_7520_var.r,2.0);
