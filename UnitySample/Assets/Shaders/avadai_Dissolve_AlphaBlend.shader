    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_1790 = (_Texture_var.a*((i.vertexColor.a*1.5+-0.5)+_noise_var.r));
                clip(node_1790 - 0.5);
////// Lighting:
////// Emissive:
                float3 emissive = (i.vertexColor.rgb*_Texture_var.rgb);
                float3 finalColor = emissive;
                return fixed4(finalColor,node_1790);
            }
            ENDCG
        }
        Pass {
