...
Shader "Toon/Glow" {
	Properties {
		...
		_AdditiveColor ("AdditiveColor", Color) = (1,0,0,1)
	}
	...
	SubShader {
		...
		Pass {
			...
			float4 frag (v2f i) : COLOR
			{
				...
				half4 glowColor = tex2D(_GlowTex, i.texcoord );
				
				return float4(2.0f * cube.rgb * col.rgb + glowColor + _Additive * _AdditiveColor.rgb, col.a);
			}
			ENDCG			
		}
	} 
